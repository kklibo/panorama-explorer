...
*/
    pub fn set_translation(&mut self, center: WorldCoords) {
        ...
        self.orientation.translate = Mat4::from_translation(cgmath::Vector3::new(center.x as f32, center.y as f32, 0f32));
    }
/*
...
*/
    pub fn set_rotation(&mut self, angle: f32) {
        ...
        self.orientation.rotate = Mat4::from_angle_z(Deg(angle));
    }
/*
