...
impl Renderer<'_> {
    ...
    pub(in super) fn render_states_transparency() -> RenderStates {
        RenderStates {
    ...
    pub(in super) fn render_states_accumulate() -> RenderStates {
        RenderStates {
            blend: Some(BlendParameters {
    ...
    pub(in super) fn render_states_no_blend() -> RenderStates {
        RenderStates {
            blend: None,
            write_mask: WriteMask::COLOR,
            depth_test: DepthTestType::Always,
