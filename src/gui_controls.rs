        ...
        window.show(gui_context, |ui| {
            ...
            match control_state.ui_mode {
                ...
                UiMode::Edit => {
                    ...
                    if ui.add(Button::new("align photos (alt)")).clicked() {

                        entities.set_photos_from_json_serde_string(&entities.photos_alignment_alt_string.clone()).unwrap();
                    }
